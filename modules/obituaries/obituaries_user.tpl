...
<br />
		...
		<b><span class="glyphicon glyphicon-calendar"></span>&nbsp;<{$smarty.const._AM_OBITUARIES_DATE}></b> : <{$obituaries_user.obituaries_formated_date}>
		...
		<b><span class="glyphicon glyphicon-info-sign"></span>&nbsp;<{$smarty.const._AM_OBITUARIES_LASTNAME}></b> : <{$obituaries_user.obituaries_lastname}>

		<br /><br />

		<div class="alert alert-success"><b><{$smarty.const._AM_OBITUARIES_DESCRIPTION}></b> :</div> <div class="well well-lg"><{$obituaries_user.obituaries_description}></div>

	
		<div class="alert alert-info"><b><{$smarty.const._AM_OBITUARIES_SURVIVORS}></b> :</div> <div class="well well-lg"><{$obituaries_user.obituaries_survivors}></div>


		<div class="alert alert-warning"><b><{$smarty.const._AM_OBITUARIES_SERVICE}></b> :</div> <div class="well well-lg"><{$obituaries_user.obituaries_service}></div>

        <{if $obituaries_user.obituaries_memorial != ""}>

		<div class="alert alert-danger"><b><{$smarty.const._AM_OBITUARIES_MEMORIAL}></b> :</div> <div class="well well-lg"><{$obituaries_user.obituaries_memorial}></div>
        <{/if}>
	</div>
	...
	<{if $obituaries_user.obituaries_uid > 0}>
		...
		<div align="center"><b><a href="<{$xoops_url}>/userinfo.php?uid=<{$obituaries_user.obituaries_uid}>"><span class="label label-danger"><{$smarty.const._AM_OBITUARIES_XOOPS_PROFILE}></span></a></b></div>
